...
var MoonpayService = /** @class */ (function () {
    ...
    MoonpayService.prototype.createTransaction = function (params) {
    ...
    MoonpayService.prototype.getPaymentUrl = function (transactionId) {
        return this.config.baseUrl + "/transaction/" + transactionId + "?apiKey=" + this.config.apiKey;
    };
    MoonpayService.prototype.getTransactionStatus = function (transactionId) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                try {
                    // Реализация
