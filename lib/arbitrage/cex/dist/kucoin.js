...
var KucoinService = /** @class */ (function () {
    function KucoinService() {
        this.config = {
    ...
    KucoinService.prototype.getPrice = function (symbol) {
    ...
    KucoinService.prototype.executeTrade = function (params) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                try {
                    // Реализация
    ...
    KucoinService.prototype.getBalances = function () {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                try {
                    // Реализация
